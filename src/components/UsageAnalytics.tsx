          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-600">Track your email protection impact</p>
              </div>
            </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Badge 
                  ...
                  className={stat.trend === 'up' ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-600'}
                >
                  {stat.change}
                </Badge>
              </div>
        ...
        <CardContent className="p-6">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-emerald-800 mb-2">Protection Impact</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <div className="text-2xl font-bold text-emerald-700">89</div>
                  <div className="text-sm text-emerald-600">Mistakes prevented</div>
                  <div className="text-xs text-emerald-500 mt-1">7.1% of all emails</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-emerald-700">156</div>
                  <div className="text-sm text-emerald-600">Emails edited after delay</div>
                  <div className="text-xs text-emerald-500 mt-1">12.5% touched before sending</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-emerald-700">$24K</div>
                  <div className="text-sm text-emerald-600">Estimated value saved</div>
                  <div className="text-xs text-emerald-500 mt-1">From prevented mistakes</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <Card className="border-0 shadow-sm bg-blue-50/50">
          <CardContent className="p-4">
            <div className="flex items-center space-x-3 mb-3">
              <TrendingUp className="w-5 h-5 text-blue-600" />
              <span className="font-medium text-blue-800">Peak Usage</span>
            </div>
